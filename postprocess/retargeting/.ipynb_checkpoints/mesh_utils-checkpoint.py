...
DATA_DIR = r"C:/work/Alibaba/vposer/extra_data"


def modify_vertices(verts):
    # Set paths
    obj_filename = os.path.join(DATA_DIR, r"hand_wrist/hand_02.obj")
    out_filename = os.path.join(DATA_DIR, r"hand_wrist/test_hand.obj")
...
def render_mesh_image():
    ...
    # Set paths
    obj_filename = os.path.join(DATA_DIR, "hand_wrist/test_hand.obj")
